...
export function ProjectDetail({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md mb-6 overflow-hidden">
      <div
        className="px-4 md:px-8 py-4 cursor-pointer hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-colors"
          ...
          <div className="flex items-center gap-2">
            {onToggleSidebar && (
              <button
                ...
                className="lg:hidden p-2 -ml-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
              >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-base md:text-lg font-bold text-gray-900 dark:text-white tracking-tight">
                  {site.title}
                </h1>
              </div>
            </div>
          ...
          <div className="flex items-center gap-2">
            {onToggleTimeline && (
              <button
                ...
                className="xl:hidden p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="px-4 md:px-8 pb-5">
        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4">
          <div className="flex items-center gap-3">
            <span className="text-sm text-gray-500 dark:text-gray-400 flex-shrink-0 w-14 text-right">{completedCount}/{totalCount}</span>
